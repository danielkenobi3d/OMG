...
#triangle cubes
import pymel.core as pm
def triangle_01(InitialPositionX, InitialPositionY):
    for position_y in range(4):
        for each in range(4-position_y):
            transform_cube, creation_cube = pm.polyCube()
            transform_cube.translateY.set(position_y + InitialPositionY)
            transform_cube.translateX.set(each + InitialPositionX)

triangle(-5,0)


def triangle_02(InitialPositionX, InitialPositionY):
    for position_y in range(4):
        for each in range(4-position_y):
            transform_cube, creation_cube = pm.polyCube()
            transform_cube.translateY.set(position_y + InitialPositionY)
            transform_cube.translateX.set(InitialPositionX - each)

triangle_02(5,0)

def triangle_03(InitialPositionX, InitialPositionY):
    for position_y in range(4):
        for each in range(4-position_y):
            transform_cube, creation_cube = pm.polyCube()
            transform_cube.translateY.set(InitialPositionY - position_y)
            transform_cube.translateX.set(InitialPositionX + each)

triangle_03(-5,10)

def triangle_04(InitialPositionX, InitialPositionY):
    for position_y in range(4):
        for each in range(4-position_y):
            transform_cube, creation_cube = pm.polyCube()
            transform_cube.translateY.set(InitialPositionY - position_y)
