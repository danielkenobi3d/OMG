...
definition = dict(
    ...
    brow=dict(
        ...
        blendShapes=dict(LOutBrowUp={'connection': 'translateY', 'value': 10},
                         LOutBrowDwn={'connection': 'translateY', 'value': -10},
                         LInBrowUp={'connection': 'translateY', 'value': 10},
                         LInBrowDwn={'connection': 'translateY', 'value': -10},
                         ),
